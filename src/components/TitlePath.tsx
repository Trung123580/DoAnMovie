...
function TitlePath({ onClickNext, onClickPrev, title, noSlide }: { title: any; onClickNext: func; onClickPrev: func; noSlide?: boolean }) {
  return (
    <div className='pt-12 mb-6 flex justify-between items-center'>
      <h3 className='text-2xl  lg:text-3xl font-extrabold capitalize flex-basis'>{title}</h3>
      {!noSlide && (
